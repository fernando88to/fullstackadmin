...
export const menuList: IMenuType[] = [
    ...
    {text: "Segmentos (statico)", icon: <DragIndicator/>, active: false, path: "/segmentos/segmentosStaticos"},
    {text: "Segmentos (swr)", icon: <DragIndicator/>, active: false, path: "/segmentos/segmentosSwr"},
